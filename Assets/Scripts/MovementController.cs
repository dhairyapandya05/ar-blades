...
public class MovementController : MonoBehaviour
{
    ...
    private float initfirstcordinate = -0.29f;
    private float initsecondcordinate = -0.54f;
    private float initthirdcordinate = 1.4f;
    ...
    void Start()
    {
        transform.position = new Vector3(initfirstcordinate, initsecondcordinate, initthirdcordinate);
